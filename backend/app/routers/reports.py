...
async def generate_report(request: ReportRequest):
    ...
    return ReportResponse(
        reportId=report_id,
        title=f"ThreatLen AI Executive Threat Intelligence Report ({request.timeHorizon})",
        ...
        executiveSummary=(
            f"During the {request.timeHorizon} monitoring period, ThreatLen AI inspected 12,540 log records. "
